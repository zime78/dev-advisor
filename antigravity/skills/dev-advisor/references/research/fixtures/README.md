...
find /Users/zime/.claude/skills/dev-advisor/references/research/fixtures -name "*.json" \
...
```bash
find /Users/zime/.claude/skills/dev-advisor/references/research/fixtures -name "*.json" | wc -l
# 기대값: 5
```
