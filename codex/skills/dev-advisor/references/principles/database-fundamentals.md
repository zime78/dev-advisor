...
데이터 모델링 패턴([`../patterns/data-modeling.md`](../patterns/data-modeling.md)) · 동시성 이론([`./concurrency-theory.md`](./concurrency-theory.md)) · 합의 알고리즘([`../algorithms/consensus.md`](../algorithms/consensus.md)) 의 **이론적 기반** 8 항목. *트랜잭션·정합성·복제·파티셔닝* 의 기본 정의와 정형 보장.
...
**핵심 가치**: 데이터베이스는 *데이터의 영속성·일관성·가용성* 을 동시에 만족시키려는 시도이며, 각 보장은 서로 *상충* 한다. 이 파일의 8 항목은 그 상충 관계를 *정의·정리·증명* 의 언어로 다루며, 패턴([data-modeling](../patterns/data-modeling.md))이 "어떻게 만드느냐" 라면 본 문서는 "왜 그 보장이 성립/실패하는가" 의 근거.

**관련 카탈로그**:
- [`../patterns/data-modeling.md`](../patterns/data-modeling.md) — 데이터 모델링 / CAP·PACELC 시스템 항목 / Replication 패턴 / Sharding 패턴
- [`./concurrency-theory.md`](./concurrency-theory.md) — Linearizability / Serializability / Snapshot Isolation / Causal Consistency / Eventual Consistency
- [`../algorithms/consensus.md`](../algorithms/consensus.md) — 2PC / Paxos / Raft (replication 의 합의 기반)
- [`../algorithms/distributed.md`](../algorithms/distributed.md) — Lamport / Vector Clock (causal ordering 의 기반)
- [`../patterns/distributed.md`](../patterns/distributed.md) — 분산 시스템 패턴 (Saga / Outbox / Read-Through 등)
...
**Serializable Snapshot Isolation (SSI)** — PostgreSQL 9.1+ 의 `SERIALIZABLE` 구현. SI 위에 *dangerous structure* 탐지를 추가하여 write skew 까지 차단. 자세한 정형 정의는 [관련: Snapshot Isolation 이론](./concurrency-theory.md#snapshot-isolation) 참조.
...
### 정합성 모델 매핑
- Serializable ↔ [관련: Serializability 이론](./concurrency-theory.md#serializability)
- Strict Serializable ↔ [관련: Linearizability](./concurrency-theory.md#linearizability) (단일 객체 한정)
...
[관련: Concurrency 이론 매핑](./concurrency-theory.md#serializability) · [관련: MVCC 알고리즘](../algorithms/concurrent.md)
...
[관련: 데이터 모델링 패턴](../patterns/data-modeling.md) · [관련: 비정규화 시스템 적용](../patterns/data-modeling.md#materialized-view)
...
| 분산 트랜잭션 across services | **Saga** (ACID 시뮬레이션) — [관련 패턴](../patterns/distributed.md) |
...
[관련: 일관성 모델 상세](#consistency-models) · [관련: CAP/PACELC](#cap-pacelc) · [관련: 분산 데이터 모델링](../patterns/data-modeling.md)
...
- **CRDT** (Shapiro 2011) — eventual consistency 를 *결정론적으로* 수렴시키는 데이터 구조. [관련: 분산 알고리즘](../algorithms/distributed.md)
...
[관련: CAP 시스템 적용](../patterns/data-modeling.md#cap-theorem) · [관련: PACELC 적용](../patterns/data-modeling.md#pacelc) · [관련: 일관성 모델](#consistency-models)
...
### 비교/대안
- **합의 알고리즘 (Paxos/Raft)** — 단일 리더 선출 + log replication 의 정확성 보장. [관련: 합의 알고리즘](../algorithms/consensus.md)
...
[관련: Single-Leader 패턴](../patterns/data-modeling.md#single-leader-replication) · [관련: Multi-Leader 패턴](../patterns/data-modeling.md#multi-leader-replication) · [관련: Leaderless](../patterns/data-modeling.md#leaderless-replication) · [관련: 분산 패턴](../patterns/distributed.md)
...
[관련: Linearizability 이론](./concurrency-theory.md#linearizability) · [관련: Causal Consistency 이론](./concurrency-theory.md#causal-consistency) · [관련: Eventual Consistency 이론](./concurrency-theory.md#eventual-consistency) · [관련: 시스템 적용 매핑](../patterns/data-modeling.md#consistency-models-systems)
...
[관련: Sharding 패턴 적용](../patterns/data-modeling.md#sharding-partitioning) · [관련: Consistent Hashing 패턴](../patterns/data-modeling.md#consistent-hashing-sharding) · [관련: 분산 알고리즘](../algorithms/distributed.md) · [관련: 분산 시스템 패턴](../patterns/distributed.md)
...
|---|---|---|
| Isolation Levels | (격리 수준은 DB 엔진별 설정) | MVCC, 2PL ([../algorithms/concurrent.md](../algorithms/concurrent.md)) |
| ANSI SQL Anomaly | (위와 동일) | Snapshot Isolation ([./concurrency-theory.md#snapshot-isolation](./concurrency-theory.md#snapshot-isolation)) |
| Normalization | [../patterns/data-modeling.md](../patterns/data-modeling.md) | — |
| ACID vs BASE | [../patterns/data-modeling.md](../patterns/data-modeling.md), [../patterns/distributed.md](../patterns/distributed.md) | — |
| CAP / PACELC | [../patterns/data-modeling.md#cap-theorem](../patterns/data-modeling.md#cap-theorem), [../patterns/data-modeling.md#pacelc](../patterns/data-modeling.md#pacelc) | — |
| Replication | [../patterns/data-modeling.md#single-leader-replication](../patterns/data-modeling.md#single-leader-replication) 외 2 | Paxos / Raft ([../algorithms/consensus.md](../algorithms/consensus.md)) |
| Consistency Models | [../patterns/data-modeling.md#consistency-models-systems](../patterns/data-modeling.md#consistency-models-systems) | Linearizability / Causal ([./concurrency-theory.md](./concurrency-theory.md)) |
| Partitioning | [../patterns/data-modeling.md#sharding-partitioning](../patterns/data-modeling.md#sharding-partitioning), [../patterns/data-modeling.md#consistent-hashing-sharding](../patterns/data-modeling.md#consistent-hashing-sharding) | Consistent Hashing ([../algorithms/distributed.md](../algorithms/distributed.md)) |

---

**관련 (P1 신설)**:
- [`../patterns/data-warehousing-bi.md`](../patterns/data-warehousing-bi.md) — OLTP/ACID 원리의 OLAP 측면 — Kimball Star / SCD / Lakehouse / dbt 으로 분석 워크로드의 일관성 모델 결정 (Snapshot Isolation, Idempotent Materialization)
