...
| 4 | **DM — Data Management** | `principles/database-fundamentals.md#tx-isolation-levels`~`#db-partitioning` + `algorithms/db-indexes.md` + `algorithms/db-storage-engines.md` + `patterns/data-modeling.md#cap-theorem`~`#data-mesh-lakehouse` + `patterns/data-access.md` + `patterns/master-data-management.md` + `patterns/data-quality-governance.md` + `patterns/data-warehousing-bi.md` (P1 t10 신설) + `algorithms/db-query-optimizer.md` (P2 t11 신설) | ✓ |
...
|---|---|---|---|
| 0 | **Data Governance (Umbrella)** | `patterns/data-quality-governance.md#dq-stewardship-raci`, `#data-lineage`, `#data-catalog`, `#openlineage-standard` + `principles/professional-ethics.md#gdpr-article-22` + `security/privacy-engineering.md#dpia`, `#purpose-binding`, `#retention-policy` | ✓ |
| 1 | **Data Architecture** | `patterns/data-modeling.md#cap-theorem`, `#pacelc`, `#consistency-models-systems`, `#sharding-partitioning`, `#consistent-hashing-sharding`, `#data-mesh-lakehouse` + `patterns/data-warehousing-bi.md` (P1 t10) | ✓ |
| 2 | **Data Modeling & Design** | `patterns/data-modeling.md` (전체 12 항목) + `principles/database-fundamentals.md#normalization-1nf-bcnf` + `patterns/master-data-management.md#mdm-hierarchy` | ✓ |
| 3 | **Data Storage & Operations** | `algorithms/db-indexes.md` (8 인덱스) + `algorithms/db-storage-engines.md` (10 엔진 기법 — WAL/LSM/SSTable/MVCC/Buffer Pool 등) + `principles/database-fundamentals.md#db-replication`, `#db-partitioning` + `algorithms/db-query-optimizer.md` (P2 t11) | ✓ |
...
| 7 | **Reference & Master Data Management** | `patterns/master-data-management.md#mdm-golden-record`, `#mdm-survivorship-rules`, `#mdm-match-merge`, `#mdm-data-steward`, `#mdm-reference-data`, `#mdm-hierarchy` (P0 t04a 신설) | ✓ |
| 8 | **Data Warehousing & Business Intelligence** | `patterns/data-warehousing-bi.md` (P1 t10 신설 — Kimball/SCD/Fact Table/OLAP/Lakehouse/dbt) + `patterns/data-modeling.md#lambda-kappa-htap`, `#data-mesh-lakehouse` | ✓ |
| 9 | **Metadata Management** | `patterns/data-quality-governance.md#data-catalog`, `#data-lineage`, `#openlineage-standard` + `patterns/mlops.md#model-card`, `#data-contract` | ✓ |
| 10 | **Data Quality** | `patterns/data-quality-governance.md#dq-6-dimensions`, `#dq-validation-tools` (P0 t04b 신설 — 6 dimensions: Accuracy/Completeness/Consistency/Timeliness/Uniqueness/Validity) + `patterns/mlops.md#data-drift`, `#data-contract` | ✓ |
...
| A03 | Injection | `security/security-api-web.md` §5 XXE / §8 Mass Assignment + `principles/database-fundamentals.md` (parameterized query 가이드) + `patterns/api-design.md#10-resource-naming` | ✓ |
...
15. `algorithms/db-storage-engines.md` — §2 KA4 / §3 KA3
